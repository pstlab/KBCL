DOMAIN T1_Domain {
	...
	COMP_TYPE SingletonStateVariable T1_SendType (Send_F(), Send_R(), Send_B(), Send_L(), Idle()) {
	...
	COMP_TYPE SingletonStateVariable T1_ReceiveType (Receive_F(), Receive_B(), Receive_R(), Receive_L(), Idle()) {
	...
	COMP_TYPE SingletonStateVariable T1_ChannelType (Channel_F_B(), Channel_R3_L3(), Channel_R3_L2(), Channel_R3_L1(), Channel_L3_L3(), Channel_L3_L2(), Channel_L3_L1(), Channel_L2_L3(), Channel_R2_R2(), Channel_R2_R1(), Channel_R2_R3(), Channel_L2_L1(), Channel_L2_L2(), Channel_L1_L1(), Channel_B_F(), Channel_B_B(), Channel_B_L3(), Channel_F_F(), Channel_L1_L2(), Channel_L1_L3(), Channel_B_L1(), Channel_L2_R3(), Channel_B_L2(), Channel_L2_R1(), Channel_L3_B(), Channel_L2_R2(), Channel_L3_F(), Channel_R2_B(), Channel_L3_R1(), Channel_L2_F(), Channel_R3_F(), Channel_R1_B(), Channel_F_R3(), Channel_L1_F(), Channel_L3_R2(), Channel_F_R1(), Channel_L3_R3(), Channel_R3_B(), Channel_F_R2(), Channel_L1_B(), Channel_L2_B(), Idle(), Channel_R2_F(), Channel_R1_R1(), Channel_R1_R2(), Channel_R2_L3(), Channel_R1_R3(), Channel_R2_L2(), Channel_R2_L1(), Channel_R1_F(), Channel_R3_R1(), Channel_R3_R2(), Channel_R3_R3(), Channel_F_L3(), Channel_F_L2(), Channel_F_L1(), Channel_B_R3(), Channel_B_R2(), Channel_B_R1(), Channel_L1_R3(), Channel_L1_R2(), Channel_L1_R1(), Channel_R1_L2(), Channel_R1_L3(), Channel_R1_L1()) {
	...
	COMP_TYPE SingletonStateVariable T1_Port_L1Type (Port_L1_Available(), Port_L1_Not_Available()) {
	...
	COMP_TYPE SingletonStateVariable T1_Cross_Conveyor_3Type (Cross_Conveyor_3_Backward(), Cross_Conveyor_3_Still(), Cross_Conveyor_3_Forward()) {
	...
	COMP_TYPE SingletonStateVariable T1_Main_ConveyorType (Main_Conveyor_Backward(), Main_Conveyor_Forward(), Main_Conveyor_Still()) {
	...
	COMP_TYPE SingletonStateVariable T1_Port_L3Type (Port_L3_Available(), Port_L3_Not_Available()) {
	...
	COMP_TYPE SingletonStateVariable T1_Port_R1Type (Port_R1_Not_Available(), Port_R1_Available()) {
	...
	COMP_TYPE SingletonStateVariable T1_Cross_Transfer_1Type (Cross_1_Changing(), Cross_1_Up(), Cross_1_Down()) {
	...
	COMP_TYPE SingletonStateVariable T1_Port_BType (Port_B_Available(), Port_B_Not_Available()) {
	...
	COMP_TYPE SingletonStateVariable T1_Port_FType (Port_F_Available(), Port_F_Not_Available()) {
	...
	COMP_TYPE SingletonStateVariable T1_Cross_Conveyor_2Type (Cross_Conveyor_2_Still(), Cross_Conveyor_2_Backward(), Cross_Conveyor_2_Forward()) {
	...
	COMP_TYPE SingletonStateVariable T1_Cross_Conveyor_1Type (Cross_Conveyor_1_Forward(), Cross_Conveyor_1_Backward(), Cross_Conveyor_1_Still()) {
	...
	COMP_TYPE SingletonStateVariable T1_Neighbor_BType (Neighbor_B_not_Available(), Neighbor_B_Available()) {
	...
	COMPONENT T1_Send { FLEXIBLE T1_Send_timeline(trex_internal_dispatch_asap) } : T1_SendType;
	COMPONENT T1_Receive { FLEXIBLE T1_Receive_timeline(trex_internal_dispatch_asap) } : T1_ReceiveType;
	...
	SYNCHRONIZE T1_Channel.T1_Channel_timeline {
		...
		VALUE Channel_F_L2() {
			...
			cd6 T1_Cross_Transfer_1.T1_Cross_Transfer_1_timeline.Cross_1_Down();
		...
		VALUE Channel_L1_R3() {
			...
			cd4 T1_Cross_Transfer_1.T1_Cross_Transfer_1_timeline.Cross_1_Up();
			STARTS_DURING [0,+INF] [0,+INF]  cd4;
		...
		VALUE Channel_R1_L2() {
			...
			cd7 T1_Cross_Conveyor_1.T1_Cross_Conveyor_1_timeline.Cross_Conveyor_1_Backward();
			STARTS_DURING [0,+INF] [0,+INF]  cd7;
		...
		VALUE Channel_L2_R3() {
			...
			cd7 T1_Cross_Conveyor_3.T1_Cross_Conveyor_3_timeline.Cross_Conveyor_3_Forward();
			STARTS_DURING [0,+INF] [0,+INF]  cd7;
		...
		VALUE Channel_L2_R1() {
			...
			cd5 T1_Cross_Conveyor_2.T1_Cross_Conveyor_2_timeline.Cross_Conveyor_2_Forward();
			STARTS_DURING [0,+INF] [0,+INF]  cd5;
		...
		VALUE Channel_L3_R1() {
			...
			cd6 T1_Cross_Conveyor_3.T1_Cross_Conveyor_3_timeline.Cross_Conveyor_3_Forward();
			STARTS_DURING [0,+INF] [0,+INF]  cd6;
		...
		VALUE Channel_L1_L2() {
			...
			cd4 T1_Cross_Conveyor_1.T1_Cross_Conveyor_1_timeline.Cross_Conveyor_1_Forward();
			STARTS_DURING [0,+INF] [0,+INF]  cd4;
		...
		VALUE Channel_L2_F() {
			...
			cd6 T1_Cross_Conveyor_2.T1_Cross_Conveyor_2_timeline.Cross_Conveyor_2_Forward();
			STARTS_DURING [0,+INF] [0,+INF]  cd6;
		...
		VALUE Channel_L3_L1() {
			...
			cd5 T1_Cross_Conveyor_3.T1_Cross_Conveyor_3_timeline.Cross_Conveyor_3_Forward();
			STARTS_DURING [0,+INF] [0,+INF]  cd5;
		...
		VALUE Channel_B_L2() {
			...
			cd6 T1_Port_B.T1_Port_B_timeline.Port_B_Available();
			STARTS_DURING [0,+INF] [0,+INF]  cd6;
		...
		VALUE Channel_L1_B() {
			...
			cd7 T1_Port_L1.T1_Port_L1_timeline.Port_L1_Available();
			STARTS_DURING [0,+INF] [0,+INF]  cd7;
		...
		VALUE Channel_R2_R3() {
			...
			cd5 T1_Cross_Conveyor_2.T1_Cross_Conveyor_2_timeline.Cross_Conveyor_2_Backward();
			STARTS_DURING [0,+INF] [0,+INF]  cd5;
		...
		VALUE Channel_R3_L1() {
			...
			cd3 T1_Cross_Conveyor_1.T1_Cross_Conveyor_1_timeline.Cross_Conveyor_1_Backward();
			ENDS_DURING [0,+INF] [0,+INF]  cd3;
			...
			cd6 T1_Cross_Conveyor_3.T1_Cross_Conveyor_3_timeline.Cross_Conveyor_3_Backward();
			STARTS_DURING [0,+INF] [0,+INF]  cd6;
		...
		VALUE Channel_L2_B() {
			...
			cd2  <?> T1_Neighbor_B.T1_Neighbor_B_timeline.Neighbor_B_Available();
			ENDS_DURING [0,+INF] [0,+INF]  cd2;
		...
		VALUE Channel_L3_R2() {
			...
			cd7 T1_Port_L3.T1_Port_L3_timeline.Port_L3_Available();
			STARTS_DURING [0,+INF] [0,+INF]  cd7;
		...
		VALUE Channel_F_R3() {
			...
			cd5  <?> T1_Neighbor_F.T1_Neighbor_F_timeline.Neighbor_F_Available();
			STARTS_DURING [0,+INF] [0,+INF]  cd5;
		...
		VALUE Channel_R1_B() {
			...
			cd7 T1_Port_R1.T1_Port_R1_timeline.Port_R1_Available();
			STARTS_DURING [0,+INF] [0,+INF]  cd7;
