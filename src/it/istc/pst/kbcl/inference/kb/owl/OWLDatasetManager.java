...
//		Resource subject = this.infModel.getResource(this.ABOX_NS + subjectName);
		Individual subject = this.model.getIndividual(this.ABOX_NS + subjectName);
		if (subject == null) {
...
//		Resource object = this.infModel.getResource(this.ABOX_NS + objectName);
		...
		// get property
//		Property p = this.infModel.getProperty(this.TBOX_NS + propertyName);
...
//		OntClass module = this.model.getOntClass(TBOX_NS + CONSTANT_MODULE_TYPE);
//		if (module == null) {
//			throw new OWLClassNotFoundException("[" + this.label + "]: Module class " + TBOX_NS + CONSTANT_MODULE_TYPE + " not found");
//		}
//		
//		// create agent individual
//		Individual t = module.createIndividual(TBOX_NS + CONSTANT_MODULE_ID);
//		if (this.debug) {
//			System.out.println("... Individual " + TBOX_NS + CONSTANT_MODULE_ID + " successfully created!");
//		}
//		
...
//	{
//		// get class
//		OntClass conveyorType = this.model.getOntClass(TBOX_NS + CONSTANT_CONVEYOR_TYPE);
//		if (conveyorType == null) {
//			throw new OWLClassNotFoundException("[" + this.label+ "]: Conveyor class " + TBOX_NS + CONSTANT_CONVEYOR_TYPE +  " not found");
//		}
//		
//		// create individuals
//		for (String conveyorName : CONSTANT_CONVEYORS) {
//			// create individual
//			Individual conveyor = conveyorType.createIndividual(TBOX_NS + conveyorName);
//			if (this.debug) {
//				System.out.println("... Individual " + TBOX_NS + conveyorName + " successfully created!");
//			}
//			
//			// associate cross transfer to module
//			Property he = this.model.getProperty(TBOX_NS + PROPERTY_LABEL_HAS_ELEMENT);
...
//	{
//		// get class
//		OntClass crossType = this.model.getOntClass(TBOX_NS + CONSTANT_CROSS_TRANSFER_TYPE);
//		if (crossType == null) {
//			throw new OWLClassNotFoundException("[" + this.label+ "]: Cross Transfer class " + TBOX_NS + CONSTANT_CROSS_TRANSFER_TYPE +  " not found");
//		}
//		
//		// create individuals
//		for (String crossName : CONSTANT_CROSS_TRANSFERS) {
//			// create individual
//			Individual cross = crossType.createIndividual(TBOX_NS + crossName);
//			if (this.debug) {
//				System.out.println("... Individual " + TBOX_NS + crossName + " successfully created!");
//			}
//			
//			// associate cross transfer to module
//			Property he = this.model.getProperty(TBOX_NS + PROPERTY_LABEL_HAS_ELEMENT);
...
//	{
//		// get neighbor type
//		OntClass neighborType = this.model.getOntClass(TBOX_NS + CONSTANT_NEIGHBOR_TYPE);
//		// check 
//		if (neighborType == null) {
//			throw new OWLClassNotFoundException("[" + this.label + "]: Neighbor class " + TBOX_NS + CONSTANT_NEIGHBOR_TYPE + " not found");
//		}
//		// index neighbor
...
//			// create individual
//			Individual n = neighborType.createIndividual(TBOX_NS + neighborName);
//			if (this.debug) {
//				System.out.println("... Individual " + TBOX_NS + neighborName + " successfully created!");
//			}
...
//		// get port type
//		OntClass portType = this.model.getOntClass(TBOX_NS + CONSTANT_PORT_TYPE);
//		if (portType == null) {
//			throw new OWLClassNotFoundException("[" + this.label + "]: Port class " + TBOX_NS + CONSTANT_PORT_TYPE + " not found");
//		}
//		
//		// create constant ports
//		for (String portName : CONSTANT_PORTS) {
//			// create individual
//			Individual i = portType.createIndividual(TBOX_NS + portName);
//			if (this.debug) {
//				System.out.println("... Individual " + TBOX_NS + portName + " successfully created!");
//			}
//			
...
//			Property c = this.model.getProperty(TBOX_NS + PROPERTY_LABEL_CONNECT);
...
//	{
//		// get function type
//		OntClass channelType = this.model.getOntClass(TBOX_NS + CONSTANT_CHANNEL_TYPE);
//		if (channelType == null) { 
//			throw new OWLClassNotFoundException("[" + this.label + "]: Channel class " + TBOX_NS + CONSTANT_CHANNEL_TYPE + " not found");
//		}
//		
//		// create constant channels
//		for (String channelName : CONSTANT_CHANNELS) {
//			// create individual
//			Individual c = channelType.createIndividual(TBOX_NS + channelName);
//			if (this.debug) {
//				System.out.println("... Individual " + TBOX_NS + channelName + " successfully created!");
//			}
//			
//			// get input/output properties
//			Property ip = this.model.getProperty(TBOX_NS + PROPERTY_LABEL_HAS_INPUT_PORT);
//			Property op = this.model.getProperty(TBOX_NS + PROPERTY_LABEL_HAS_OUTPUT_PORT);
